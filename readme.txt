 ...
 This will deploy two artifacts, target/oreganoERP.war and
 default-ds.xml.
 ...
 - http://localhost:8080/oreganoERP/
 ...
 Now you can either deploy the target/oreganoERP.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/oreganoERP.war

 To undeploy the application, run:

  ./asadmin undeploy oreganoERP
